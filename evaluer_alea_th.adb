...
procedure Evaluer_Alea_TH is
	...
	is
		...
		package Ma_TH is 
			new TH(Taille_TH => 1000 ,T_Cle => Integer, T_Donnee => Integer, fonction_hachage=>hachage);
		use Ma_TH;
	...
	begin
		...
		for i in 1..Taille loop
			Get_Random_Number(RandomValue);
			Enregistrer(Sda, RandomValue, La_Donnee(Sda, RandomValue)+1);
		end loop;
